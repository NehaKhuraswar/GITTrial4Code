'use strict';
var rapcollaboratorController = ['$scope', '$modal', 'alertService', 'rapcollaboratorFactory', '$location', 'rapGlobalFactory', function ($scope, $modal, alert, rapFactory, $location, rapGlobalFactory) {
    var self = this;
 ...
 //   })
    self.SearchInviteCollaborator = function (email) {
        self.showEmailFound = false;
        self.showEmailNotFound = false;
        rapFactory.SearchInviteCollaborator(email).then(function (response) {
