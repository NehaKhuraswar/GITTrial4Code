    ...
    $routeProvider
        ...
        .when('/additionaldocuments', {
         ...
         .when('/emailnotificationsent', {
             ...
             controller: rapEmailNotificationSentController,
             controllerAs: 'Ctrl',
             resolve: rapEmailNotificationSentController_resolve
         })
         .when('/usmailnotification', {
             templateUrl: 'views/account/USMailNotification.html',
             controller: rapMailController,
             controllerAs: 'Ctrl',
        ...
        .when('/ViewAppeal', {
            templateUrl: 'views/account/ViewAppeal.html',
            controller: rapViewAppealController,
            controllerAs: 'Ctrl',
            resolve: rapViewAppealController_resolve
        })
        .when('/ViewTenantResponse', {
            templateUrl: 'views/account/ViewTenantResponse.html',
