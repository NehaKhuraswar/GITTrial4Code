...
;(function($) {
  $.textcounter = function(el, options) {
    ...
    base.init = function() {
      ...
      base.$el.after('<' + base.options.countContainerElement + ' class="' + base.options.countContainerClass + '"><span class="' + base.options.textCountClass + '">' + counterNum+'</span> / '+ base.options.max + ' '+ counterText + '</' + base.options.countContainerElement + '>');
