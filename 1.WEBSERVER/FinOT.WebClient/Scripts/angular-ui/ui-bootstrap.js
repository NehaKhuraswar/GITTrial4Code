...
Date: 09/03/2015
By: Sarat Annapaneni
Problem: Modal dislog doesnot close on browser back button or location.path("new location");
Fix: Added this function --> $rootScope.$on('$locationChangeSuccess', function () {

Date: 11/14/2015
By: Sarat Annapaneni
Problem: IE datepicker is not closing;
Fix: Added a null safe check on popupEl[0].contains for IE
    ...
    return {
        ...
        link: function (scope, element, attrs, ngModel) {
            ...
            var documentClickBind = function (event) {
                //Fixed on: 11/14/2015 - Added a null safe check on popupEl[0].contains for IE
                if (scope.isOpen && !(element[0].contains(event.target) || (popupEl[0].contains && popupEl[0].contains(event.target)))) {
                    scope.$apply(function () {
                        scope.isOpen = false;
                    });
                }
