...
namespace RAP.WebClient
{
    ...
    public class ApplicationProcessingController : ApiController
    {
        ...
        [AllowAnonymous]
        [Route("gettenantresponseexemptcontestedinfo/{TenantResponseID}/{CustomerID}")]
        [HttpGet]
        public HttpResponseMessage GetTenantResponseExemptContestedInfo(string TenantResponseID, string CustomerID)
        {
            HttpResponseMessage responseMessage;
            try
            {
                ...
                client.BaseAddress = new Uri(_baseURL);
                client.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                string requestUri = _requestURI + "gettenantresponseexemptcontestedinfo/" + TenantResponseID + "/" + CustomerID;
                responseMessage = client.GetAsync(requestUri).Result;
                if (responseMessage.IsSuccessStatusCode)
                {
                    return responseMessage;
        ...
        [AllowAnonymous]
        [Route("GetTenantAppealInfoForView/{CID}")]
        [HttpGet]
        public HttpResponseMessage GetTenantAppealInfoForView(string CID)
        {
            HttpResponseMessage responseMessage;
            try
            {
                ...
                client.BaseAddress = new Uri(_baseURL);
                client.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                string requestUri = _requestURI + "GetTenantAppealInfoForView/" + CID;
                responseMessage = client.GetAsync(requestUri).Result;
                if (responseMessage.IsSuccessStatusCode)
                {
                    return responseMessage;
        ...
        public HttpResponseMessage GetTenantResponseViewInfo(string CID)
        {
            ...
            try
            {
                ...
                client.BaseAddress = new Uri(_baseURL);
                client.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                string requestUri = _requestURI + "GetTenantResponseViewInfo/" + CID;
                responseMessage = client.GetAsync(requestUri).Result;
                if (responseMessage.IsSuccessStatusCode)
                {
                    return responseMessage;
        ...
        [AllowAnonymous]
        [Route("SaveTenantDocuments/{CustomerID}")]
        [HttpPost]
        public HttpResponseMessage SaveTenantDocuments(string CustomerID)
        {
            HttpResponseMessage responseMessage;
            try
            {
                ...
                client.BaseAddress = new Uri(_baseURL);
                client.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                string requestUri = _requestURI + "SaveTenantDocuments/" + CustomerID;
                responseMessage = client.PostAsync(requestUri, Request.Content).Result;
                if (responseMessage.IsSuccessStatusCode)
                {
                    return responseMessage;
        ...
        [AllowAnonymous]
        [Route("SaveAppealDocuments/{CustomerID}")]
        [HttpPost]
        public HttpResponseMessage SaveAppealDocuments(string CustomerID)
        {
            HttpResponseMessage responseMessage;
            try
            {
                ...
                client.BaseAddress = new Uri(_baseURL);
                client.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                string requestUri = _requestURI + "SaveAppealDocuments/" + CustomerID;
                responseMessage = client.PostAsync(requestUri, Request.Content).Result;
                if (responseMessage.IsSuccessStatusCode)
                {
                    return responseMessage;
        ...
        [AllowAnonymous]
        [Route("GetOwnerReviewByCaseID/{CID}")]
        [HttpGet]
        public HttpResponseMessage GetOwnerReviewByCaseID(string CID)
        {
            HttpResponseMessage responseMessage;
            try
            {
                ...
                client.BaseAddress = new Uri(_baseURL);
                client.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                string requestUri = _requestURI + "GetOwnerReviewByCaseID/" + CID;
                responseMessage = client.GetAsync(requestUri).Result;
                if (responseMessage.IsSuccessStatusCode)
                {
                    return responseMessage;
        ...
        [AllowAnonymous]
        [Route("GetOResponseViewByCaseID/{CID}")]
        [HttpGet]
        public HttpResponseMessage GetOResponseViewByCaseID(string CID)
        {
            HttpResponseMessage responseMessage;
            try
            {
                ...
                client.BaseAddress = new Uri(_baseURL);
                client.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
                string requestUri = _requestURI + "GetOResponseViewByCaseID/" + CID;
                responseMessage = client.GetAsync(requestUri).Result;
                if (responseMessage.IsSuccessStatusCode)
                {
                    return responseMessage;
